    ...
    return (
      <div className='bg-white w-[80%] min-h-[40%] items-center justify-center'>
          <div id="invoiceCapture">
            <div>
              <div
                className="flex flex-row justify-between items-start w-100 p-4 bg-fuchsia-100"
              >
                <div className="w-100">
                  <h4 className="fw-bold my-2 text-[50px]">
                    {" "}
          ...
          <div className="pb-4 px-4">
            <div className="flex flex-row gap-3">
              <div className="flex flex-col cols-md-6 w-full">
                <button
                  className="flex w-100 mt-3 mt-md-0 bg-primaryColor items-center justify-center p-2 rounded-lg text-white"
