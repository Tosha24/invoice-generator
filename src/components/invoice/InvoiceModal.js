            ...
            <div className="p-4">
              <div className="mb-4 flex flex-row">
                <div className="flex flex-col cols-md-4 w-full">
                  <div className="fw-bold">Billed to:</div>
                  <div className='font-medium text-lg'>{this.props.info.billTo || ""}</div>
                  <div>{(this.props.info.billToAddress.length>0) ? this.props.info.billToAddress+"," : " "}</div>
                  <div>
                    {(this.props.info.billToCity.length > 0) ? this.props.info.billToCity+"," : " "}{(this.props.info.billToState.length > 0) ? " "+this.props.info.billToState+"." : " "}
                  </div>
                  <div className='flex flex-row mt-1'>
                    <span className='font-[500]'>Email</span>:&nbsp;
                    <span className=''>{this.props.info.billToEmail || ""}</span>
                  </div>
                  <div className='flex flex-row'>
                    <span className='font-[500]'>Contact</span>:&nbsp;
                    <span>{this.props.info.billToContact || ""}</span>
                  </div>
                </div>
                <div className="flex flex-col cols-md-4 w-full">
                  <div className="fw-bold">Billed From:</div>
                  <div className='font-medium text-lg'>{user.data.companyName || ""}</div>
                  <div>{(user.data.address.length > 0) ? user.data.address : " "}</div>
                  <div>
                    {(user.data.city.length > 0)?user.data.city : " "}{(user.data.state.length > 0)?user.data.state : " "}
                  </div>
