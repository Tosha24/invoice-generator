      ...
      <div>
        <Modal show={this.props.showModal} onHide={this.props.closeModal} size="lg" centered>
          <div id="invoiceCapture">
            <div className="d-flex flex-row justify-content-between align-items-start w-100 p-4" style={divStyle}>
              <div className="w-100">
                <h4 className="fw-bold my-2 text-[50px]"> {this.props.info.billFrom}</h4>
