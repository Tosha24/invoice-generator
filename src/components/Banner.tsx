...
const Banner = () => {
  return (
    <section className="max-w-container flex flex-row">
      <div className='flex flex-col min-w-fit gap-3 lg:gap-7 py-16 md:py-32 ml-[10%]'>
      <h3 className="text-sm font-titleFont tracking-widest text-primary">
        MEET EZ-INVOICE
      </h3>
      ...
      <Link href="/signup">
        <button className="border w-48 h-12 text-lg text-white border-primary bg-primary tracking-wide font-titleFont hover:bg-hoverColor duration-300">
          Get started
        </button>
      </Link>
      </div>
